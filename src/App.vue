...
<template>
  <div class="flex size-full flex-col">
    <div class="flex items-center justify-between bg-orange-500 p-4">
      ...
      <div class="flex items-center gap-x-2 bg-white">
        <button
    ...
    >
      <div v-for="(day, index) in daysTitle" :key="index" class="p-2 text-center">
        {{ day }}
      </div>
    </div>
    <div
      class="grid size-full flex-1 overflow-y-auto"
      :class="{
    ...
    >
      ...
      <template v-if="mode === modes.Week">
        <div class="grid grid-cols-8">
          <div class="col-start-1 col-end-2 border-b border-r" />
          <div
            class="w-full border-b border-r p-2 text-center"
          ...
          <div class="col-start-1 col-end-9 grid h-12 w-full grid-cols-8 border-b">
            <div class="col-start-1 col-end-2 border-r p-2 text-center">All day</div>
            <div v-for="day in weekDays" :key="day.id" class="border-r p-2"></div>
          </div>
          <div
            class="col-start-1 col-end-9 grid h-36 w-full grid-cols-8 border-b"
        ...
        <div class="flex size-full">
          <div class="w-full">
            ...
            <div class="flex h-36 items-start border" v-for="(time, index) in hours24" :key="index">
              ...
              <div class="flex w-full flex-1 basis-full px-2"></div>
            </div>
          </div>
        </div>
      </template>
